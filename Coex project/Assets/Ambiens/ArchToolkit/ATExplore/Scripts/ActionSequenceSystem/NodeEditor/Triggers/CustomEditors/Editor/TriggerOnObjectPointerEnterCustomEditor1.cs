...
namespace ambiens.archtoolkit.atexplore.actionSystem{
    [CustomNodeEditor(typeof(TriggerOnObjectPointerExit))]
    public class TriggerOnObjectPointerExitCustomEditor : NodeEditor
    {
        ...
        public override void OnBodyGUI()
        {
            ...
            var trigger = target as TriggerOnObjectPointerExit;
