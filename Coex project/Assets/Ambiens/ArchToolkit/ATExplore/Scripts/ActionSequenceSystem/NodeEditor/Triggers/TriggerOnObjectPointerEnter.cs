...
{
    [CreateNodeMenuAttribute("Triggers/Trigger On Object Pointer Enter")]
	public class TriggerOnObjectPointerEnter : ATriggerBase
    {
        ...
        protected override void _RuntimeInit()
        {
            ...
            ArchToolkit.ArchToolkitManager.Instance.visitor.raycaster.OnHover += this.OnHover;
        ...
        private void OnHover(Ray r, RaycastHit h)
        {
            if (h.transform != null)
            {
